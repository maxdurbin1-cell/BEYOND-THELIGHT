...
(function () {
  ...
  function getCrucibleExpeditionPersonalFlavorOptions() {
    var allFlavors = [
      ...
      'Plastic Bones: Ad6 to Body Checks when performing an action using this flavor',
      ...
      'Stone Skin: Ad4 to Defend (Passive)',
      ...
      'Healer: Restore Valor Die roll in Stress with a Touch',
      ...
      'Runesmith: Your weapon carries the rune — +Valor Die bonus damage on next Strike or Shoot this scene',
      ...
      'Beacon Heart: Allies in Close range gain +Valor Die bonus to Trauma checks',
      'Clockmind: +Valor Die bonus to Control on trap or lock interactions',
      ...
      'Cold Reader: +Valor Die bonus to Spirit checks in social or deception scenes',
      'Iron Stomach: Consume any backpack item — roll Valor Die, reduce Health by that amount for an unpredictable boon',
      'Stormglass Eye: See hidden movement in rain/fog',
      'Banner Oath: +Valor Die bonus to Lead while carrying a mission objective',
      ...
      'Lantern Scholar: +Valor Die bonus to Mind checks in darkness or ruins',
      ...
      'Chain Tactician: First ally action after yours gains +Valor Die bonus',
      'Cinder Skin: Ignore heat and ember hazards — travel Hot planets without damage or Coolant Layer',
      'Vault Memory: Returning to a visited route grants +Valor Die bonus and +1 Path Token',
      'Hunt Rhythm: After a successful Defend, next Strike gains +Valor Die bonus',
      'Vowkeeper: +Valor Die bonus on checks tied to your current active task',
      'Steel Prayer: Once per day, negate one Trauma gain',
      'Ghoststride: Movement does not trigger simple traps',
      'Iridescent Blood: Recover +Valor Die additional Stress when using any remedy',
      ...
      'Shard Focus: +Valor Die bonus to Control when using hacks or relics',
      'Ashen Halo: First reveal steals 1 enemy Action this round',
      'Dawnbreaker: First Morning action gains +Valor Die bonus',
      'Duskcaller: First Evening action gains +Valor Die bonus',
      'Gale Step: Gain free reposition on crit success',
      'Sable Ward: Reduce first incoming Mental Stress each scene by your Valor Die roll',
      'Fracture Sight: Spot weak points — +Valor Die bonus to next Shoot check',
      'Torchbearer: Allies ignore first darkness penalty',
      'Oathbound Medic: Long Rest heals +1 Trauma',
      'Circuit Saint: +Valor Die bonus to Hack and old-world device checks',
      'Feral Grace: +Valor Die bonus to Defend checks against beasts',
